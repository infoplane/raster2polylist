...
def main():
    ...
    raster2polylist = Raster2PolyList('lnrs', 'postgres', 'localhost', 'outrider77')
    processed_list = raster2polylist.makeTRowList(list4Devon)
    raster2polylist.updateRasterTable(processed_list)
